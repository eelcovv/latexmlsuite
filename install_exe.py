...
2.: pip install latexmlsuite --no-index --find-links <name of the wheel file> --prefix <location> -U
Installs the APP as a library

3.: python install.py install --prefix <location>
Installs the latexmlsuite executable
...
parser = argparse.ArgumentParser("Install the executable of the latexmlsuite")
...
docs_location = destination / Path("docs") / Path(args.app_name)
